...
public class TimeStamp {
	...
	/**
	 * this method sets the variable lastUpdate to an Calendar Object which represents the current time
	 */
	public void update() {
	 ...
	 * @throws UpdateTimeInTheFutureException thrown if the new calendar is in the future
	 */
