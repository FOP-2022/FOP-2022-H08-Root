...
public class TestTimeStampExceptions {
	...
	private void test(TimeStamp timestamp, Calendar calendar, int n) throws Exception {
		switch(n) {
		case 1: timestamp.updateWithExc1(calendar); break;
		case 2: timestamp.updateWithExc2(calendar); break;
		case 3: timestamp.updateWithExc3(calendar); break;
		case 4: timestamp.updateWithExc4(calendar); break;
		case 5: timestamp.updateWithExc5(calendar); break;
		}
	}
